  ...
  return (
    <Section id="about">
      <Container>
        ...
        <Box> 
        <Title>
        Welcome To The <br /> Astra NFTs Club.
        </Title>
        <SubText>
        The ASTRA CLUB is a collection of NFTs—unique digital collectibles. The Astras are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS.
        </SubText>
        <SubTextLight>
